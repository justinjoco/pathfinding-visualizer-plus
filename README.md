...
- Have user be able to change end location while moving
- UI cleanup

Everything below this line was automatically generated by Create React App, but I modified them to use `yarn`
